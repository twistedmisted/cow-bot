...
public class RefusePlaceChangingHandlerTest extends BotApiSpringBootTest {

    @Autowired
    private RefusePlaceChangingHandler refusePlaceChangingHandler;
    ...
    @Test
    public void handleMessageWithExistingUserAndPlaceShouldRefuseChanging() {
        Long queueId = 1L;
        ...
        Update update = createCallbackUpdateFromGroupChatWithMessageText(userIdTo,
                String.format("refuse_place_changing_q_%d_pf_%d_pt_%d", queueId, userIdFrom, userIdTo));
        ...
        refusePlaceChangingHandler.handleMessage(update);
        ...
        assertEquals(mentionUser(userPlaceFrom.getUser())
                        + ", "
    ...
    public void handleMessageWithNotExistingPlaceToShouldReturnNotifyMessage() {
        Update update = createCallbackUpdateFromGroupChatWithMessageText("refuse_place_changing_q_1_pf_1_pt_2");
