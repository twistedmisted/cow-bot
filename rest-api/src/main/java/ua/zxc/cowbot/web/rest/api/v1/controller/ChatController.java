...
//                            responseCode = "200",
//                            description = "Success",
//                            content = @Content(schema = @Schema(ref = "#/components/schemas/Chats"))
//                    ),
//                    @ApiResponse(
//                            responseCode = "400",
...
//            }
//    )
    @GetMapping(value = "/user/{userId}", consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE)
    public ResponseEntity<Map<String, Object>> getAllByUserId(@Parameter(description = "User id")
        ...
        responseBody.put("chats", chatsByUserId.stream()
                .collect(Collectors.toMap(ChatDTO::getId, ChatDTO::getName)));
